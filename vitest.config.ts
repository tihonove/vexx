  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        "src/vs/workbench/tui/controller.ts",
        ...
        "src/vs/platform/extensions/common/grammarContribution.ts",
        "src/vs/editor/common/languages/languageConfiguration.ts",
        "src/vs/platform/extensions/common/languageContribution.ts",
        ...
        "src/vs/platform/theme/common/editorTokenTheme.ts",
        "src/vs/platform/theme/common/themeFile.ts",
