...
import { loadConfiguration } from "./vs/platform/configuration/node/configurationService.ts";
import { loadState } from "./vs/platform/state/node/stateService.ts";
import { loadUserKeybindings } from "./vs/platform/keybinding/node/keybindingsService.ts";
...
import { installVsix, listInstalledExtensions, uninstallExtension } from "./vs/platform/extensionManagement/node/extensionInstaller.ts";
import { scanExtensions } from "./vs/platform/extensions/common/extensionScanner.ts";
...
import type { ICommandContribution, IConfigurationContribution } from "./vs/platform/extensions/common/extensionManifest.ts";
