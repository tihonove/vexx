...
import type { IQuickAccessProvider, QuickAccessItem } from "./QuickAccess/IQuickAccessProvider.ts";
import type { QuickAccessRegistry } from "./QuickAccess/QuickAccessRegistry.ts";
import { QuickAccessRegistryDIToken } from "./QuickAccess/QuickAccessRegistry.ts";
