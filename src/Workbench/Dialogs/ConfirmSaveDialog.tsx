 ...
 * дерево контролов; цвета — только из активной темы.
 */
export class ConfirmSaveDialog extends DialogComponent {
    ...
    protected override describe(theme: WorkbenchTheme): JsxNode {
        ...
        const infoFg = theme.getRequiredColor("descriptionForeground");
        const warnFg = theme.getRequiredColor("editorWarning.foreground");
        // "! " — the "!" is at index 0
        const warningCharStyles = new Map<number, StyledChar>([[0, { fg: warnFg }]]);
        ...
        return (
            <BoxContainer bg={bg} fg={fg} borderFg={borderFg} title="Visual Studio Code" titleFg={fg} hasSeparator>
                <PaddingContainer left={2} right={2} bg={bg}>
                    <VStack>
                        ...
                        <TextLabel
                            ...
                            layout={{ width: "stretch", height: 1 }}
                        />
                        <TextLabel text="   them." fg={infoFg} bg={bg} layout={{ width: "stretch", height: 1 }} />
                        <TextLabel text="" fg={fg} bg={bg} layout={{ width: "stretch", height: 1 }} />
