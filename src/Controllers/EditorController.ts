...
import { EditorViewState } from "../vs/editor/common/viewModel/editorViewState.ts";
...
import { computeIndentationFolds } from "../vs/editor/contrib/folding/common/foldingRangeProvider.ts";
...
import { createTextEdit } from "../vs/editor/common/core/textEdit.ts";
import type { IUndoElement } from "../vs/editor/common/model/undoElement.ts";
import type { IMarkerDecoration } from "../vs/platform/markers/common/markers.ts";
import { TextDocument } from "../vs/editor/common/model/textDocument.ts";
import { PlainTextTokenizer } from "../vs/editor/common/languages/plainTextTokenizer.ts";
import { DocumentTokenStore } from "../vs/editor/common/tokens/documentTokenStore.ts";
