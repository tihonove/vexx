...
describe("AppController — Rename via context menu", () => {
    let ws: ITempWorkspace;
    let h: IAppHarness;
    ...
    it("Rename... entry prompts and renames the clicked file", async () => {
        ...
        tree.dispatchEvent(new TUIMouseEvent("click", { button: "right", screenX: 2, screenY: 0, localX: 2, localY: 0 }));
        h.testApp.render();
