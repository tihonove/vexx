...
export class TerminalRenderer {
    ...
    constructor(out: WritableOutput = process.stdout) {
        this.out = out;
    }
     ...
     */
    render(currentGrid: Grid, previousGrid: Grid): void {
        ...
        // in a weird state between frames.
        if (activeStyle !== StyleFlags.None || activeFg !== DEFAULT_COLOR || activeBg !== DEFAULT_COLOR) {
            buf += "\x1b[0m";
        }
