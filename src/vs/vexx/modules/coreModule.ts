import type { ContainerModule, ServiceAccessor } from "../../platform/instantiation/common/instantiation.ts";
import type { TuiApplication } from "../../base/tui/tuiApplication.ts";
import { ServiceAccessorDIToken, TuiApplicationDIToken } from "../../workbench/tui/coreTokens.ts";
