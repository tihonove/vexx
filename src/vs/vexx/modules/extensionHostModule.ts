...
import { CommandServiceAdapter } from "../../workbench/api/tui/mainThreadCommands.ts";
import { EditorDecorationsServiceAdapter } from "../../workbench/api/tui/mainThreadEditorDecorations.ts";
import { EditorOptionsServiceAdapter } from "../../workbench/api/tui/mainThreadEditorOptions.ts";
import {
    ExtensionHost,
    ExtensionHostDIToken,
    type IExtensionHostConfigProvider,
} from "../../workbench/services/extensions/node/extensionHost.ts";
import { FileDecorationsServiceAdapter } from "../../workbench/api/tui/mainThreadDecorations.ts";
import { ThemeColorResolverAdapter } from "../../workbench/api/tui/mainThreadThemeColors.ts";
