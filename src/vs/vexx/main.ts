...
import type { ICliArgs } from "../platform/environment/node/argv.ts";
import { CliArgsError, parseCliArgs, USAGE } from "../platform/environment/node/argv.ts";
...
import { FileSink } from "../platform/log/node/fileLog.ts";
import { RingBufferSink } from "../platform/log/common/bufferLog.ts";
import { OscClipboard } from "../platform/clipboard/tui/oscClipboard.ts";
import { resolveUserDataPaths } from "../platform/environment/node/userDataPath.ts";
import { VEXX_VERSION } from "../platform/product/common/product.ts";
...
import { AppControllerDIToken } from "../workbench/tui/workbench.ts";
...
import { ExtensionTokenizationContributor } from "../workbench/services/textMate/common/extensionTokenizationContributor.ts";
import { ExtensionHostDIToken } from "../workbench/services/extensions/node/extensionHost.ts";
import { runExtensionHostSubprocess } from "../workbench/api/node/extensionHostProcess.ts";
import type { IExtensionRegistration } from "../workbench/services/extensions/common/extensionEntry.ts";
import type { ICommandContribution, IConfigurationContribution } from "../platform/extensions/common/extensionManifest.ts";
