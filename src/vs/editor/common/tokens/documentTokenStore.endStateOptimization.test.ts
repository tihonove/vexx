...
import { createInsertEdit } from "../core/textEdit.ts";
import { TextDocument } from "../model/textDocument.ts";

import { DocumentTokenStore } from "./documentTokenStore.ts";
import type { IState } from "../languages/state.ts";
import type { ITokenizationResult, ITokenizationSupport } from "../languages/tokenizationSupport.ts";
