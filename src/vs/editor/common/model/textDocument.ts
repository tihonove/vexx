...
import type { IDocumentContentChange } from "./documentContentChange.ts";
import type { IDocumentLanguageChange } from "./documentLanguageChange.ts";
import { comparePositions } from "../core/position.ts";
import type { IRange } from "../core/range.ts";
import { createRange } from "../core/range.ts";
import type { IApplyEditsResult, ITextDocument } from "../model.ts";
