...
import type { IFoldingRegion } from "../model/foldingRegion.ts";
import type { ILineTokens } from "../tokens/lineTokens.ts";
import { detectIndentation } from "../model/indentationDetector.ts";
import type { IPosition } from "../core/position.ts";
import { comparePositions } from "../core/position.ts";
import type { IRange } from "../core/range.ts";
import { createRange } from "../core/range.ts";
import type { ISelection } from "../core/selection.ts";
import {
...
import type { ITextDocument } from "../model.ts";
import type { ITextEdit } from "../core/textEdit.ts";
import { createTextEdit } from "../core/textEdit.ts";
import type { IUndoElement } from "../model/undoElement.ts";
