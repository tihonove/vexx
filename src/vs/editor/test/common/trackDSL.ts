...
import { reject } from "../../../base/common/types.ts";
import { EditorViewState } from "../../common/viewModel/editorViewState.ts";
import type { IFoldingRegion } from "../../common/model/foldingRegion.ts";
import { createFoldingRegion } from "../../common/model/foldingRegion.ts";
import type { ILineTokens } from "../../common/tokens/lineTokens.ts";
import { createLineTokens, createToken } from "../../common/tokens/lineTokens.ts";
import { comparePositions } from "../../common/core/position.ts";
import type { ISelection } from "../../common/core/selection.ts";
...
import { PlainTextTokenizer } from "../../common/languages/plainTextTokenizer.ts";
