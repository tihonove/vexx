...
import type { KeyboardEventLike } from "./keybindingsRegistry.ts";
import { formatKeybinding, KeybindingRegistry, parseChord, parseKeybinding } from "./keybindingsRegistry.ts";
