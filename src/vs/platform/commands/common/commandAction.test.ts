...
import { Container, token } from "../../instantiation/common/instantiation.ts";
...
import type { KeyboardEventLike } from "../../keybinding/common/keybindingsRegistry.ts";
import { KeybindingRegistry, parseChord, parseKeybinding } from "../../keybinding/common/keybindingsRegistry.ts";
