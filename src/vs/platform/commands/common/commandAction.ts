import type { ServiceAccessor } from "../../instantiation/common/instantiation.ts";
import type { IDisposable } from "../../../base/common/lifecycle.ts";

import type { CommandRegistry } from "./commands.ts";
import type { Keybinding, KeybindingChord, KeybindingRegistry } from "../../keybinding/common/keybindingsRegistry.ts";
