...
import type { ICompletionRequest, ICoreCompletionItem } from "../../../../editor/common/languages.ts";
import type { IRange } from "../../../../editor/common/core/range.ts";
import type { ISaveEdit, ISaveSnapshot } from "../../textfile/common/saveParticipant.ts";

import type { ICommandService } from "../../../api/common/commandService.ts";
import { type IEditorDecorationsService, NULL_EDITOR_DECORATIONS_SERVICE } from "../../../api/common/editorDecorationsService.ts";
import type { IEditorOptionsPatch, IEditorOptionsService } from "../../../api/common/editorOptionsService.ts";
import type { IExtensionRegistration } from "../common/extensionEntry.ts";
import { type IFileDecorationsService, NULL_FILE_DECORATIONS_SERVICE } from "../../../api/common/fileDecorationsService.ts";
import type { IIpcEndpoint } from "./ipcMessageChannel.ts";
import { IpcMessageChannel } from "./ipcMessageChannel.ts";
import { type IThemeColorResolver, NULL_THEME_COLOR_RESOLVER } from "../../../api/common/themeColorResolver.ts";
...
import {
    ...
    themeColorIdOf,
} from "../../../api/common/extHost.protocol.ts";
