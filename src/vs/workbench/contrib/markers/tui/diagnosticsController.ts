...
import { getDefaultConfiguration } from "../../../../platform/configuration/common/defaults.ts";
...
import { MarkerServiceDIToken, SettingsResourceDIToken } from "../../../tui/coreTokens.ts";
import { collectKnownSettingKeys, validateSettingsJson } from "../../preferences/common/settingsDiagnostics.ts";
import type { EditorController } from "../../../tui/parts/editor/editorController.ts";
import type { EditorGroupController } from "../../../tui/parts/editor/editorGroupController.ts";
import { EditorGroupControllerDIToken } from "../../../tui/parts/editor/editorGroupController.ts";
