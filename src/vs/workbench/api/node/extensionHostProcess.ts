...
import type { IIpcEndpoint } from "../../services/extensions/node/ipcMessageChannel.ts";
import { IpcMessageChannel } from "../../services/extensions/node/ipcMessageChannel.ts";
import { RpcEndpoint } from "../../services/extensions/common/rpcProtocol.ts";
import type { WorkspaceConfigStore } from "../common/extHostConfiguration.ts";
import { buildVscodeNamespace } from "../common/extHost.api.impl.ts";
