...
import type { WireTextEdit } from "./extHost.protocol.ts";

import { ExtHostTextDocument } from "./extHostDocuments.ts";
import { createFileSystemNamespace } from "./extHostFileSystem.ts";
import type { IVscodeHostContext } from "./extHostContext.ts";
import { DisposableImpl, EndOfLine, EventEmitter, TextDocumentSaveReason, TextEdit, Uri } from "./extHostTypes.ts";
