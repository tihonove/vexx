...
import { buildCommandsNamespace } from "./extHostCommands.ts";
import { DocumentRegistry } from "./extHostDocuments.ts";
import { createLanguagesNamespace } from "./extHostLanguages.ts";
...
import {
    ...
    ThemeColor,
    Uri,
} from "./extHostTypes.ts";
import { createWindowNamespace } from "./extHostWindow.ts";
import { WorkspaceConfigStore } from "./extHostConfiguration.ts";
import { createWorkspaceNamespace } from "./extHostWorkspace.ts";
