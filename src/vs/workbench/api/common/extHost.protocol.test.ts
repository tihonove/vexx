...
import { createInProcessChannelPair } from "../../services/extensions/common/inProcessChannelPair.ts";
import { RpcEndpoint } from "../../services/extensions/common/rpcProtocol.ts";
import type { WireCompletionItem, WireTextEdit } from "./extHost.protocol.ts";
import {
