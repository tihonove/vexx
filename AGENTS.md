...
- **Рост `vscode.d.ts`** — нужные блоки **дословно раскомментируются** из upstream-копии, их нельзя сужать/переписывать. Тянет незакомментированные типы — раскомментируй и их, либо отложи блок целиком. Детали → [docs/arch/Extensions.md](docs/arch/Extensions.md).
