...
а под редактором — **нижняя Panel** (Problems/Output/…), выровненная по ширине редактора
...
`SashElement` (`src/vs/base/tui/ui/sash/sashElement.ts`) — невидимый хит-таргет на границе панелей;
