...
- [~] [IntegratedTerminal](IntegratedTerminal.md) — встроенный терминал (node-pty + @xterm/headless как in-process tmux); спайк-песочница в `src/demos/terminal/`, зафиксирована упаковка (embed + runtime-extract)
