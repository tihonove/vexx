...
- [~] [DiffBugs](DiffBugs.md) — баги дифф-смотрелки, найденные e2e-тестированием: устаревший снимок при повторном Compare (закрыт в #202); открыт — Compare до подъёма git-провайдера врёт «нет версии в git» (гонка активации)
