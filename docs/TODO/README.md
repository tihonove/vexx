...
- [~] [WorkbenchContributions](WorkbenchContributions.md) — перенос vscode contribution points (реестр contributions #164, MenuRegistry #166, vscode-канон меню #168 — меню-бар на реестре, co-location placement, IMenu, MenuId-класс; далее QuickAccess/Configuration/Color-реестры)
...
Файлы: `src/vs/base/common/unicodeWidth.ts`, bootstrap в `src/App/`/`main.ts`, `src/vs/tui/backend/`.
...
Файлы: `src/vs/base/browser/ui/scrollbar/scrollableElement.ts`, `src/demos/WASDScrollableElement.ts`, `src/vs/base/browser/events/`
...
Файлы: `src/vs/base/browser/ui/layout/hFlexElement.ts`
...
Файлы: `src/vs/base/browser/ui/scrollbar/iScrollable.ts`, `src/vs/base/common/geometryPromitives.ts`
...
Файлы: `src/vs/base/browser/events/focusManager.ts`, `src/vs/base/browser/TuiApplication.ts`, `src/vs/base/browser/tuiElement.ts`
