...
- [~] [WorkbenchContributions](WorkbenchContributions.md) — перенос vscode contribution points (реестр contributions #164, MenuRegistry #166 готовы; далее меню-бар на реестр + submenus/navigation, co-location placement, QuickAccess/Configuration/Color-реестры)
