...
- [~] [WorkbenchRefactoring](WorkbenchRefactoring.md) — Controllers → Workbench (Services + Components), контролы TUIDom как «вещь в себе» (стандарт `IXxxStyles`, мост тема→стили, растворение контроллеров)
