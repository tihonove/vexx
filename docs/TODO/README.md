...
Файлы: `src/vs/base/tui/ui/scrollbar/scrollableElement.ts`, `src/demos/WASDScrollableElement.ts`, `src/vs/base/tui/events/`
...
Файлы: `src/vs/base/tui/ui/layout/hFlexElement.ts`
...
Файлы: `src/vs/base/common/scrollable.ts`, `src/vs/base/common/geometry.ts`
...
Файлы: `src/vs/base/tui/events/focusManager.ts`, `src/vs/base/tui/TuiApplication.ts`, `src/vs/base/tui/tuiElement.ts`
