...
Файлы: `src/vs/base/browser/ui/scrollbar/scrollableElement.ts`, `src/demos/WASDScrollableElement.ts`, `tuidom/dom/events/`
...
Файлы: `src/vs/base/browser/ui/scrollbar/iScrollable.ts`, `tuidom/common/geometryPromitives.ts`
